...
public class AEISender extends PayloadSender {
    ...
    protected HttpURLConnection getConnection() throws IOException {
        final String urlString = getProtocol() + agentConfiguration.getCrashCollectorHost() + CRASH_COLLECTOR_PATH + "?anr=true";
        ...
        connection.setConnectTimeout(AEI_COLLECTOR_TIMEOUT);
        connection.setReadTimeout(AEI_COLLECTOR_TIMEOUT);
    ...
    public PayloadSender call() {
        setPayload(aei.toString().getBytes());
